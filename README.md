...
This is a wrapper/port of <b>Professor Layton: Lost Future HD</b> for the *PS Vita*.
...
- Obtain your copy of *Professor Layton: Lost Future HD* legally for Android in form of an `.apk` file and an obb. [You can get all the required files directly from your phone](https://stackoverflow.com/questions/11012976/how-do-i-get-the-apk-of-an-installed-app-without-root-access) or by using an apk extractor you can find in the play store.
- Open the apk with your zip explorer and extract the file `libll3.so` from the `lib/armeabi-v7a` folder to `ux0:data/layton_future`. 
- Extract the folder `assets` inside `ux0:data/layton_future`.
- Extract the `obb` file in `ux0:data/layton_future/data` and rename the file `main.obb`.
